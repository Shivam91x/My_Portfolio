    ...
    <nav className="fixed top-0 z-99 flex w-full items-center justify-between border-b-1  border-b-gray-800 bg-black/80 px-16 py-6 text-white backdrop-blur-md md:justify-evenly">
      ...
      <ul className="hidden md:flex gap-5">
        <li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:text-purple-500 hover:opacity-100">
          <a href="https://github.com/Shivam91x">
            {" "}
            <BsGithub />
          </a>
        </li>
        <li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:text-blue-500 hover:opacity-100">
          <a href="https://www.linkedin.com/in/shivam-yadav0001/">
            <BsLinkedin />
          </a>
        </li>
        <li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:text-red-500 hover:opacity-100">
          <a href="https://www.instagram.com/itzz__shivamyadav/">
            <BsInstagram />
          </a>
        </li>
      </ul>
      ...
      {
        <div
          className={`fixed top-[84px] right-0 transition-transform duration-300 md:hidden flex h-screen w-1/2 flex-col items-start gap-10 border border-gray-800 bg-black/80 backdrop-blur-md p-12 transform ${isOpen ? "translate-x-0" : "translate-x-full"
            }`}
        >
          {/* display page links */}
